...
export function TextArea(props: ExtendedTextInputProps) {
  ...
  let className = cn([
    "select-none bg-(--bg-a) hover:bg-(--bg-e) rounded-[6px] px-[6px] py-[6px] border-[2px] border-(--fg-e) hover:border(--fg-i) focus:outline-[1px] focus:-outline-offset-[2px] focus:outline-(--c-a-e) h-full flex-grow",
    l?.class,
  ...
  return (
    <div class="flex flex-col gap-[2px] flex-grow w-full">
      <label class="text-[14px] select-none pl-[16px] pb-[8px]">
        {l.label}
      </label>
      <textarea
